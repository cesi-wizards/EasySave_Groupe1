...
public class BackupConfig(string name, string sourcePath, string targetPath, BackupType type, string logFileType, List<string> encryptType, string encryptKey)
{
    ...
    public List<string> EncryptType { get; init; } = encryptType;
