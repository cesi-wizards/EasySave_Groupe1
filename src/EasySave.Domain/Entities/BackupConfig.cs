...
public class BackupConfig(string name, string sourcePath, string targetPath, BackupType type, string logFileType, List<string> encryptTypes, string encryptKey)
{
